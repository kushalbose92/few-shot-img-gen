    ...
    def eval(self, MODEL_PATH):
        ...
        for i in range(self.meta_test_epochs):
            ...
            for t_idx in range(self.meta_test_batch):
                ...
                print("Reconstruction Loss \t Inter-Clustering Loss \t Intra-Clustering Loss \n")

                # Inner loop
                for step in range(self.steps_per_task):

                    # Support set as input to the model
                ...
                # Generated Point Visualization in 2D space
                UtilFunctions().neighborhood_visual(latent_proto, latent_radius)

                # Plot of the three Loss Functions
